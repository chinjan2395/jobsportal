    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="userccount"> {!! Form::open(array('method' => 'post', 'route' => ['enquiry.job', $slug])) !!}
                    <div class="formpanel"> 
                        <!-- Ad Information -->
                        <h5>{{__('Enquiry')}}</h5>
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="formrow{{ $errors->has('content') ? ' has-error' : '' }}">
                                    {!! Form::textarea('content', '', array('class'=>'form-control', 'id'=>'content', 'placeholder'=>__('Content'), 'required'=>'required')) !!}
