                    ...
                    <div class="portlet light portlet-fit portlet-datatable bordered">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-settings font-dark"></i> <span
                                        class="caption-subject font-dark sbold uppercase">Employees</span></div>
                            <div class="actions"><a href="{{ route('create.employee') }}" class="btn btn-xs btn-success"><i
                                            class="glyphicon glyphicon-plus"></i> Add New Employee</a></div>
                        </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover"
                                        ...
                                        <tr role="row" class="filter">
                                            <td><input type="text" class="form-control" name="name" id="name"
                                                       autocomplete="off" placeholder="Employee Name"></td>
                                            <td><input type="text" class="form-control" name="email" id="email"
                                                       autocomplete="off" placeholder="Employee Email"></td>
